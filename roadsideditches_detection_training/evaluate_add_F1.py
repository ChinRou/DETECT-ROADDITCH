...
if __name__ == '__main__':
    ...
    ENCODER = 'se_resnext50_32x4d' # choose encoder, e.g. mobilenet_v2 or efficientnet-b7
    ENCODER_WEIGHTS = 'imagenet' # use `imagenet` pre-trained weights for encoder initialization
    CLASSES = ['green', 'yellow', 'blue', 'orange', 'red']# 改 # model output channels (number of classes in your dataset) 
    ACTIVATION = 'sigmoid'
    DEVICE = 'cuda'
